...
set(PROJECT_FILE_REORG_INC_DIR    ${PROJECT_SOURCE_DIR}/library/include/rocsolver)
set(PROJECT_WRAPPER_TEMPLATE_FILE ${PROJECT_SOURCE_DIR}/header.hpp.in)
set(PROJECT_WRAPPER_INC_DIR       ${PROJECT_BINARY_DIR}/rocsolver/include)
...
set(PROJECT_WRAPPER_INC_RELATIVE_PATH     "${include_statements}#include \"../../include/rocsolver")
set(PROJECT_SLINK_INC_RELATIVE_PATH       "${include_statements}#include \"./rocsolver")


# Function for Generating Wrapper Headers for Backward Compatibilty
# Generates wrapper for all *.h files in include/rocsolver folder.
# No Arguments to function.
# Wrapper are generated under rocsolver/include and symlink under include.
function (package_wrapper_headers)
	# Get list of *.h files in folder include/rocsolver 
...
# Wrapper generated for the input file under rocsolver/include and symlink under include.
function (package_wrapper_headerfile gen_file_name)
