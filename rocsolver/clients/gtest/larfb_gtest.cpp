...
const vector<vector<int>> matrix_size_range = {
    ...
    {15, 15, 5, 0, 15, 0}, // invalid
    {12, 5, 12, 0, 5, 0},   {5, 12, 15, 1, 5, 0},
    {15, 10, 15, 0, 5, 1}, // invalid
    {15, 15, 15, 0, 15, 0}, {18, 20, 20, 1, 20, 0},
    {20, 18, 20, 0, 20, 0}, {20, 30, 20, 1, 30, 0},
    {50, 35, 50, 0, 50, 0}, {40, 40, 40, 0, 15, 1},
    {40, 40, 40, 1, 25, 1}};
...
const vector<vector<int>> large_matrix_size_range = {
    ...
    {640, 640, 700, 0, 640, 0},     {840, 1024, 840, 1, 1024, 0},
    {2547, 1980, 2547, 0, 2547, 0}, {200, 200, 220, 0, 100, 1},
...
Arguments larfb_setup_arguments(larfb_tuple tup) {
  ...
  arg.transH_option =
      reflector_size[3] == 0 ? 'N' : (reflector_size[3] == 1 ? 'T' : 'C');
