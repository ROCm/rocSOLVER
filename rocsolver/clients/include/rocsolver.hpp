...
template <typename T>
inline rocblas_status rocsolver_org2r(rocblas_handle handle, rocblas_int m, rocblas_int n, rocblas_int k, T *A, 
                                      rocblas_int lda, T *Ipiv);

template <>
inline rocblas_status rocsolver_org2r(rocblas_handle handle, rocblas_int m, rocblas_int n, rocblas_int k, float *A,  
                                      rocblas_int lda, float *Ipiv) {
  return rocsolver_sorg2r(handle, m, n, k, A, lda, Ipiv);
}

template <>
inline rocblas_status rocsolver_org2r(rocblas_handle handle, rocblas_int m, rocblas_int n, rocblas_int k, double *A,  
...
template <typename T>
inline rocblas_status rocsolver_orgqr(rocblas_handle handle, rocblas_int m, rocblas_int n, rocblas_int k, T *A, 
                                      rocblas_int lda, T *Ipiv);

template <>
inline rocblas_status rocsolver_orgqr(rocblas_handle handle, rocblas_int m, rocblas_int n, rocblas_int k, float *A,  
                                      rocblas_int lda, float *Ipiv) {
  return rocsolver_sorgqr(handle, m, n, k, A, lda, Ipiv);
}

template <>
inline rocblas_status rocsolver_orgqr(rocblas_handle handle, rocblas_int m, rocblas_int n, rocblas_int k, double *A,  
                                      rocblas_int lda, double *Ipiv) {
...
template <typename T>
inline rocblas_status rocsolver_orgl2(rocblas_handle handle, rocblas_int m, rocblas_int n, rocblas_int k, T *A, 
                                      rocblas_int lda, T *Ipiv);

template <>
inline rocblas_status rocsolver_orgl2(rocblas_handle handle, rocblas_int m, rocblas_int n, rocblas_int k, float *A,  
                                      rocblas_int lda, float *Ipiv) {
  return rocsolver_sorgl2(handle, m, n, k, A, lda, Ipiv);
}

template <>
inline rocblas_status rocsolver_orgl2(rocblas_handle handle, rocblas_int m, rocblas_int n, rocblas_int k, double *A,  
                                      rocblas_int lda, double *Ipiv) {
...
template <typename T>
inline rocblas_status rocsolver_orglq(rocblas_handle handle, rocblas_int m, rocblas_int n, rocblas_int k, T *A, 
                                      rocblas_int lda, T *Ipiv);

template <>
inline rocblas_status rocsolver_orglq(rocblas_handle handle, rocblas_int m, rocblas_int n, rocblas_int k, float *A,  
                                      rocblas_int lda, float *Ipiv) {
  return rocsolver_sorglq(handle, m, n, k, A, lda, Ipiv);
}

template <>
inline rocblas_status rocsolver_orglq(rocblas_handle handle, rocblas_int m, rocblas_int n, rocblas_int k, double *A,  
                                      rocblas_int lda, double *Ipiv) {
...
template <typename T>
inline rocblas_status rocsolver_ormbr(rocblas_handle handle, rocblas_storev storev, rocblas_side side, rocblas_operation trans, 
...
template <typename T>
inline rocblas_status rocsolver_orgbr(rocblas_handle handle, rocblas_storev storev, rocblas_int m, rocblas_int n, rocblas_int k, T *A, 
                                      rocblas_int lda, T *Ipiv);

template <>
inline rocblas_status rocsolver_orgbr(rocblas_handle handle, rocblas_storev storev, rocblas_int m, rocblas_int n, rocblas_int k, float *A,  
                                      rocblas_int lda, float *Ipiv) {
  return rocsolver_sorgbr(handle, storev, m, n, k, A, lda, Ipiv);
}

template <>
inline rocblas_status rocsolver_orgbr(rocblas_handle handle, rocblas_storev storev, rocblas_int m, rocblas_int n, rocblas_int k, double *A,  
                                      rocblas_int lda, double *Ipiv) {
