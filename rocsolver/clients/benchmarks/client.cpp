...
//         ". Diabled if not specified. If enabled, user specified m,n,k will be nullified")
 ...
 // }
  ...
  if (function == "potf2") {
    ...
    if (precision == 's')
      testing_gebd2_batched<float,float>(argus);
    else if (precision == 'd')
      testing_gebd2_batched<double,double>(argus);
    else if (precision == 'c')
      testing_gebd2_batched<rocblas_float_complex,float>(argus);
    else if (precision == 'z')
      testing_gebd2_batched<rocblas_double_complex,double>(argus);
  } 
  else if (function == "gebd2_strided_batched") {
    if (precision == 's')
      testing_gebd2_strided_batched<float,float>(argus);
    else if (precision == 'd')
      testing_gebd2_strided_batched<double,double>(argus);
    else if (precision == 'c')
      testing_gebd2_strided_batched<rocblas_float_complex,float>(argus);
    else if (precision == 'z')
      testing_gebd2_strided_batched<rocblas_double_complex,double>(argus);
  } 
