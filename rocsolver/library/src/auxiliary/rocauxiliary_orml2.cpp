...
template <typename T>
rocblas_status rocsolver_orml2_impl(rocblas_handle handle, const rocblas_side side, const rocblas_operation trans, 
                                   ...
                                   const rocblas_int k, T* A, const rocblas_int lda, T* ipiv, T *C, const rocblas_int ldc)
{
    ...
    // argument checking
    rocblas_status st = rocsolver_orml2_ormlq_argCheck(side,trans,m,n,k,lda,ldc,A,C,ipiv);
    ...
    rocsolver_orml2_getMemorySize<T,false>(side,m,n,batch_count,&size_1,&size_2,&size_3,&size_4);
    ...
    rocblas_status status = 
           rocsolver_orml2_template<T>(handle,side,trans,
                                      m,n,k,
