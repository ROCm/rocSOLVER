...
template <typename T>
rocblas_status
rocsolver_org2r_ung2r_impl(rocblas_handle handle, const rocblas_int m,
  ...
  rocsolver_org2r_ung2r_getMemorySize<T, false>(m, n, batch_count, &size_1,
                                                &size_2, &size_3);
  ...
  // execution
  rocblas_status status = rocsolver_org2r_ung2r_template<T>(
