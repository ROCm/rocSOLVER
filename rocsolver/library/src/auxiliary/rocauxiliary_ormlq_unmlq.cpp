...
rocblas_status rocsolver_ormlq_unmlq_impl(rocblas_handle handle, const rocblas_side side, const rocblas_operation trans, 
                                          ...
                                          const rocblas_int k, T* A, const rocblas_int lda, T* ipiv, T *C, const rocblas_int ldc)
{
    ...
    rocsolver_ormlq_unmlq_getMemorySize<T,false>(side,m,n,k,batch_count,&size_1,&size_2,&size_3,&size_4);
    ...
    rocblas_status status = 
           rocsolver_ormlq_unmlq_template<false,false,T>(handle,side,trans,
                                                         m,n,k,
...
ROCSOLVER_EXPORT rocblas_status rocsolver_cunmlq(rocblas_handle handle,
                                                 ...
                                                 const rocblas_int ldc)
{
    return rocsolver_ormlq_unmlq_impl<rocblas_float_complex>(handle, side, trans, m, n, k, A, lda, ipiv, C, ldc);
}
...
ROCSOLVER_EXPORT rocblas_status rocsolver_zunmlq(rocblas_handle handle,
                                                 ...
                                                 const rocblas_int ldc)
{
    return rocsolver_ormlq_unmlq_impl<rocblas_double_complex>(handle, side, trans, m, n, k, A, lda, ipiv, C, ldc);
}
