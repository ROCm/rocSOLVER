                                            ...
                                            const rocblas_int batch_count)
{
    ...
    if(!handle)
        ROCSOLVER_RETURN_TOP("getrs_batched", rocblas_status_invalid_handle);
    ...
    if(st != rocblas_status_continue)
        ROCSOLVER_RETURN_TOP("getrs_batched", st);
    ...
    if(rocblas_is_device_memory_size_query(handle))
        ROCSOLVER_RETURN_TOP("getrs_batched",
    ...
    if(!mem)
        ROCSOLVER_RETURN_TOP("getrs_batched", rocblas_status_memory_error);
    ...
    // execution
    ROCSOLVER_RETURN_TOP("getrs_batched",
                         rocsolver_getrs_template<true, T>(handle, trans, n, nrhs, A, shiftA, lda,
