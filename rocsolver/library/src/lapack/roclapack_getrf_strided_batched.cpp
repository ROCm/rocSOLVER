                                        ...
                                        rocblas_int *ipiv, const rocblas_stride strideP, rocblas_int* info, const rocblas_int batch_count, const int pivot) 
{
    ...
    rocblas_status perf_status = rocblasCall_trsm_mem<false,T,U>(handle,rocblas_side_left,m,n,batch_count,x_temp,x_temp_arr,invA,invA_arr);    
    ...
    rocblas_status status =
           rocsolver_getrf_template<false,true,T,S>(handle,m,n,
