...
rocblas_status rocsolver_geql2_impl(rocblas_handle handle, const rocblas_int m,
                                        ...
                                        T* ipiv)
{
    ...
    rocsolver_geql2_getMemorySize<T,false>(m,n,batch_count,&size_1,&size_2,&size_3,&size_4);
...
ROCSOLVER_EXPORT rocblas_status rocsolver_sgeql2(rocblas_handle handle, const rocblas_int m, const rocblas_int n, float *A,
                 const rocblas_int lda, float *ipiv)
{
    return rocsolver_geql2_impl<float>(handle, m, n, A, lda, ipiv);
}

ROCSOLVER_EXPORT rocblas_status rocsolver_dgeql2(rocblas_handle handle, const rocblas_int m, const rocblas_int n, double *A,
                 const rocblas_int lda, double *ipiv)
{
    return rocsolver_geql2_impl<double>(handle, m, n, A, lda, ipiv);
}

ROCSOLVER_EXPORT rocblas_status rocsolver_cgeql2(rocblas_handle handle, const rocblas_int m, const rocblas_int n, rocblas_float_complex *A,
                 const rocblas_int lda, rocblas_float_complex *ipiv)
{
    return rocsolver_geql2_impl<rocblas_float_complex>(handle, m, n, A, lda, ipiv);
}

ROCSOLVER_EXPORT rocblas_status rocsolver_zgeql2(rocblas_handle handle, const rocblas_int m, const rocblas_int n, rocblas_double_complex *A,
