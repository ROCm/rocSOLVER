                                                    ...
                                                    const rocblas_int batch_count)
{
    ...
    if(!handle)
        ROCSOLVER_RETURN_TOP("gebd2_strided_batched", rocblas_status_invalid_handle);
    ...
    if(st != rocblas_status_continue)
        ROCSOLVER_RETURN_TOP("gebd2_strided_batched", st);
    ...
    if(rocblas_is_device_memory_size_query(handle))
        ROCSOLVER_RETURN_TOP("gebd2_strided_batched",
    ...
    if(!mem)
        ROCSOLVER_RETURN_TOP("gebd2_strided_batched", rocblas_status_memory_error);
