...
rocblas_status rocsolver_ssytd2_batched(rocblas_handle handle,
                                ...
                                const rocblas_int batch_count)
{
    return rocsolver_sytd2_hetd2_batched_impl<float, float>(handle, uplo, n, A, lda, D, strideD, E, strideE, tau, strideP, batch_count);
}
...
rocblas_status rocsolver_dsytd2_batched(rocblas_handle handle,
                                ...
                                const rocblas_int batch_count)
{
    return rocsolver_sytd2_hetd2_batched_impl<double, double>(handle, uplo, n, A, lda, D, strideD, E, strideE, tau, strideP, batch_count);
}
...
rocblas_status rocsolver_chetd2_batched(rocblas_handle handle,
                                ...
                                const rocblas_int batch_count)
{
    return rocsolver_sytd2_hetd2_batched_impl<float, rocblas_float_complex>(handle, uplo, n, A, lda, D, strideD, E, strideE, tau, strideP, batch_count);
}
...
rocblas_status rocsolver_zhetd2_batched(rocblas_handle handle,
                                ...
                                const rocblas_int batch_count)
{
    return rocsolver_sytd2_hetd2_batched_impl<double, rocblas_double_complex>(handle, uplo, n, A, lda, D, strideD, E, strideE, tau, strideP, batch_count);
}
