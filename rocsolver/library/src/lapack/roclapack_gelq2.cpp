                                    ...
                                    T* ipiv)
{
    ...
    if(!handle)
        ROCSOLVER_RETURN_TOP("gelq2", rocblas_status_invalid_handle);
    ...
    if(!mem)
        ROCSOLVER_RETURN_TOP("gelq2", rocblas_status_memory_error);
