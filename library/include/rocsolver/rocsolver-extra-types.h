...
{
    rocsolver_rfinfo_mode_general = 271, /**< To work with general sparse matrices. This is the default mode. */
    rocsolver_rfinfo_mode_symmetric = 272, /**< To work with symmetric positive definite sparse matrices. */
