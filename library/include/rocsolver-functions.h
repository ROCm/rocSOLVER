...
/*! @{
    \brief GELS_OUTOFPLACE solves an overdetermined (or underdetermined) linear system defined by an m-by-n
    matrix A, and a corresponding matrix B, using the QR factorization computed by \ref rocsolver_sgeqrf "GEQRF" (or the LQ
    factorization computed by \ref rocsolver_sgelqf "GELQF").
    ...
    B         pointer to type. Array on the GPU of dimension ldb*nrhs.\n
              On entry, the matrix B.
    @param[in]
    ldb       rocblas_int. ldb >= m if trans is none; ldb >= n otherwise.\n
              Specifies the leading dimension of matrix B.
    @param[out]
...
/*! @{
    \brief GELS_OUTOFPLACE_BATCHED solves a batch of overdetermined (or underdetermined) linear systems
    defined by a set of m-by-n matrices \f$A_i\f$, and corresponding matrices \f$B_i\f$, using the
    QR factorizations computed by \ref rocsolver_sgeqrf_batched "GEQRF_BATCHED" (or the LQ factorizations computed by \ref rocsolver_sgelqf_batched "GELQF_BATCHED").
...
ROCSOLVER_EXPORT rocblas_status rocsolver_sgels_outofplace_batched(rocblas_handle handle,
                                                                   rocblas_operation trans,
                                                                   const rocblas_int m,
                                                                   const rocblas_int n,
                                                                   const rocblas_int nrhs,
...
ROCSOLVER_EXPORT rocblas_status rocsolver_dgels_outofplace_batched(rocblas_handle handle,
                                                                   rocblas_operation trans,
                                                                   const rocblas_int m,
                                                                   const rocblas_int n,
                                                                   const rocblas_int nrhs,
...
ROCSOLVER_EXPORT rocblas_status rocsolver_cgels_outofplace_batched(rocblas_handle handle,
                                                                   rocblas_operation trans,
                                                                   const rocblas_int m,
                                                                   const rocblas_int n,
                                                                   const rocblas_int nrhs,
...
ROCSOLVER_EXPORT rocblas_status rocsolver_zgels_outofplace_batched(rocblas_handle handle,
                                                                   rocblas_operation trans,
                                                                   const rocblas_int m,
                                                                   const rocblas_int n,
                                                                   const rocblas_int nrhs,
...
/*! @{
    \brief GELS_OUTOFPLACE_STRIDED_BATCHED solves a batch of overdetermined (or underdetermined) linear
    systems defined by a set of m-by-n matrices \f$A_i\f$, and corresponding matrices \f$B_i\f$,
    using the QR factorizations computed by \ref rocsolver_sgeqrf_strided_batched "GEQRF_STRIDED_BATCHED"
    (or the LQ factorizations computed by \ref rocsolver_sgelqf_strided_batched "GELQF_STRIDED_BATCHED").
    ...
    strideX   rocblas_stride.\n
              Stride from the start of one matrix X_i to the next one X_(i+1).
              There is no restriction for the value of strideX. Normal use case is strideX >= ldx*nrhs
    @param[out]
    info      pointer to rocblas_int. Array of batch_count integers on the GPU.\n
              If info[i] = 0, successful exit for solution of A_i.
              If info[i] = j > 0, the solution of A_i could not be computed because input
...
ROCSOLVER_EXPORT rocblas_status
    rocsolver_sgels_outofplace_strided_batched(rocblas_handle handle,
                                               rocblas_operation trans,
                                               const rocblas_int m,
                                               const rocblas_int n,
                                               const rocblas_int nrhs,
...
ROCSOLVER_EXPORT rocblas_status
    rocsolver_dgels_outofplace_strided_batched(rocblas_handle handle,
                                               rocblas_operation trans,
                                               const rocblas_int m,
                                               const rocblas_int n,
                                               const rocblas_int nrhs,
...
ROCSOLVER_EXPORT rocblas_status
    rocsolver_cgels_outofplace_strided_batched(rocblas_handle handle,
                                               rocblas_operation trans,
                                               const rocblas_int m,
                                               const rocblas_int n,
                                               const rocblas_int nrhs,
...
ROCSOLVER_EXPORT rocblas_status
    rocsolver_zgels_outofplace_strided_batched(rocblas_handle handle,
                                               rocblas_operation trans,
                                               const rocblas_int m,
                                               const rocblas_int n,
                                               const rocblas_int nrhs,
