...
#define GETRF_NPVT_BATCH_NUM_INTERVALS_REAL 9
#define GETRF_NPVT_BATCH_INTERVALS_REAL 24, 30, 40, 48, 56, 448, 512, 896, 1408
#define GETRF_NPVT_BATCH_BLKSIZES_REAL 0, -1, 0, -16, -24, -32, -64, 32, 96, 512
