...
#define GETRF_NPVT_NUM_INTERVALS 4
#define GETRF_NPVT_INTERVALS 65, 1249, 2753, 8449
#define GETRF_NPVT_BLKSIZES 1, 32, 256, 288, 416
#define GETRF_NPVT_BATCH_NUM_INTERVALS 3
#define GETRF_NPVT_BATCH_INTERVALS 52, 148, 1376
#define GETRF_NPVT_BATCH_BLKSIZES 1, 16, 32, 288
