...
// getri
#define GETRI_SMALL_SIZE 64
#define GETRI_NUM_INTERVALS 1
#define GETRI_INTERVALS 1025
#define GETRI_BLKSIZES 1, 256
#define GETRI_BATCH_NUM_INTERVALS 2
#define GETRI_BATCH_INTERVALS 257, 913
#define GETRI_BATCH_BLKSIZES -1, 1, 256

// TRTRI
#define TRTRI_NUM_INTERVALS 1
#define TRTRI_INTERVALS 0
#define TRTRI_BLKSIZES 0, 0
#define TRTRI_BATCH_NUM_INTERVALS 2
#define TRTRI_BATCH_INTERVALS 40, 505
#define TRTRI_BATCH_BLKSIZES 0, 16, 32
