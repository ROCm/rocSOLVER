...
#define GETRF_BATCH_NUM_INTERVALS_REAL 3
#define GETRF_BATCH_INTERVALS_REAL 52, 800, 1024
#define GETRF_BATCH_BLKSIZES_REAL 0, 32, 64, 160
...
#define GETRF_BATCH_NUM_INTERVALS_COMPLEX 4
#define GETRF_BATCH_INTERVALS_COMPLEX 24, 64, 768, 1024
#define GETRF_BATCH_BLKSIZES_COMPLEX 0, 24, 48, 64, 160
