...
/*!\file
 * \brief rocblas_template_api.h provides Basic Linear Algebra Subprograms of
 * Level 1, 2 and 3, using HIP optimized for AMD HCC-based GPU hardware. This
 * library can also run on CUDA-based NVIDIA GPUs. This file exposes C++
 * templated BLAS interface with only the precision templated.
 */
...
template <typename T>
rocblas_status rocblas_swap(rocblas_handle handle, rocblas_int n, T *x,
                            rocblas_int incx, T *y, rocblas_int incy);
...
template <typename T>
rocblas_status rocblas_iamin(rocblas_handle handle, rocblas_int n, const T *x,
                             rocblas_int incx, rocblas_int *result);

template <typename T>
rocblas_status rocblas_axpy(rocblas_handle handle, rocblas_int n,
...
template <typename T>
rocblas_status rocblas_syr(rocblas_handle handle, rocblas_fill uplo,
                           rocblas_int n, const T *alpha, const T *x,
                           rocblas_int incx, T *A, rocblas_int lda);

template <typename T>
rocblas_status rocblas_gemv(rocblas_handle handle, rocblas_operation transA,
                            rocblas_int m, rocblas_int n, const T *alpha,
...
rocblas_status rocblas_symv(rocblas_handle handle, rocblas_fill uplo,
                            rocblas_int n, const T *alpha, const T *A,
                            rocblas_int lda, const T *x, rocblas_int incx,
                            const T *beta, T *y, rocblas_int incy);

template <typename T>
rocblas_status rocblas_geam(rocblas_handle handle, rocblas_operation transA,
                            rocblas_operation transB, rocblas_int m,
                            rocblas_int n, const T *alpha, const T *A,
                            rocblas_int lda, const T *beta, const T *B,
                            rocblas_int ldb, T *C, rocblas_int ldc);

template <typename T>
rocblas_status
rocblas_gemm(rocblas_handle handle, rocblas_operation transA,
...
rocblas_status rocblas_gemm_strided_batched(
    ...
    rocblas_int lda, rocblas_int bsa, const T *B, rocblas_int ldb,
    rocblas_int bsb, const T *beta, T *C, rocblas_int ldc, rocblas_int bsc,
    rocblas_int batch_count);

template <typename T>
rocblas_status rocblas_gemm_kernel_name(
    rocblas_handle handle, rocblas_operation transA, rocblas_operation transB,
    rocblas_int m, rocblas_int n, rocblas_int k, const T *alpha, const T *A,
    rocblas_int lda, rocblas_int bsa, const T *B, rocblas_int ldb,
    rocblas_int bsb, const T *beta, T *C, rocblas_int ldc, rocblas_int bsc,
...
template <typename T>
rocblas_status rocblas_gemm_strided_batched_kernel_name(
    rocblas_handle handle, rocblas_operation transA, rocblas_operation transB,
    rocblas_int m, rocblas_int n, rocblas_int k, const T *alpha, const T *A,
    rocblas_int lda, rocblas_int bsa, const T *B, rocblas_int ldb,
    rocblas_int bsb, const T *beta, T *C, rocblas_int ldc, rocblas_int bsc,
...
template <typename T>
rocblas_status rocblas_trtri_batched(rocblas_handle handle, rocblas_fill uplo,
                                     rocblas_diagonal diag, rocblas_int n, T *A,
                                     rocblas_int lda, rocblas_int bsa, T *invA,
                                     rocblas_int ldinvA, rocblas_int bsinvA,
                                     rocblas_int batch_count);

template <typename T, rocblas_int NB>
rocblas_status rocblas_trtri_trsm(rocblas_handle handle, rocblas_fill uplo,
                                  rocblas_diagonal diag, rocblas_int n, T *A,
