...
__global__ void init_ident(const rocblas_int m, const rocblas_int n, const rocblas_int k, U A,
...
__global__ void setdiag(const rocblas_int j, U A, 
                        const rocsolver_int shiftA, const rocsolver_int lda, const rocsolver_int strideA,
                        T *ipiv, const rocsolver_int strideP)
{
...
template <typename T>
__global__ void restau(const rocblas_int k, T *ipiv, const rocblas_int strideP)
{
    const auto blocksizex = hipBlockDim_x;
                                   ...
                                   const rocsolver_int strideP, const rocsolver_int batch_count)
{
    ...
    hipLaunchKernelGGL(init_ident<T>,dim3(blocksx,blocksy,batch_count),dim3(32,32),0,stream,
