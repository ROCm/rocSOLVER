                                    ...
                                    T* A, const rocsolver_int lda)
{
    ...
    return rocsolver_larfb_template<T>(handle,side,trans,direct, 
                                      m,n,k,
...
{
    return rocsolver_larfb_impl<float>(handle, side, trans, direct, m, n, k, V, ldv, T, ldt, A, lda);
}
...
ROCSOLVER_EXPORT rocsolver_status rocsolver_dlarfb(rocsolver_handle handle,
                                                 ...
                                                 const rocsolver_int lda)
{
    return rocsolver_larfb_impl<double>(handle, side, trans, direct, m, n, k, V, ldv, T, ldt, A, lda);
}
