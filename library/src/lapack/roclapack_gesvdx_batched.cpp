...
{
    ROCSOLVER_ENTER_TOP("gesvdx_batched", "--left_svect", left_svect, "--right_svect", right_svect, "--srange", srange, "-m", m,
                        "-n", n, "--lda", lda, "--vl", vl, "--vu", vu, "--il", il, "--iu", iu, "--strideS", strideS, "--ldu", ldu, "--strideU", strideU, 
...
rocblas_status rocsolver_sgesvdx_batched(rocblas_handle handle,
                                ...
                                const rocblas_int batch_count)
{
    return rocsolver_gesvdx_batched_impl<float>(handle, left_svect, right_svect, srange, m, n, A, lda, 
...
rocblas_status rocsolver_dgesvdx_batched(rocblas_handle handle,
                                ...
                                const rocblas_int batch_count)
{
    return rocsolver_gesvdx_batched_impl<double>(handle, left_svect, right_svect, srange, m, n, A, lda, 
                                        vl, vu, il, iu, nsv, S, strideS, U, ldu, strideU, V, ldv, strideV, ifail, strideF, info, batch_count);
}
...
rocblas_status rocsolver_cgesvdx_batched(rocblas_handle handle,
                                ...
                                const rocblas_int batch_count)
{
    return rocsolver_gesvdx_batched_impl<rocblas_float_complex>(handle, left_svect, right_svect, srange, m, n, A, lda,
                                                        vl, vu, il, iu, nsv, S, strideS, U, ldu, strideU, V, ldv, strideV, ifail, strideF, info, batch_count);
}
...
rocblas_status rocsolver_zgesvdx_batched(rocblas_handle handle,
                                ...
                                const rocblas_int batch_count)
{
    return rocsolver_gesvdx_batched_impl<rocblas_double_complex>(handle, left_svect, right_svect, srange, m, n, A, lda,
                                                        vl, vu, il, iu, nsv, S, strideS, U, ldu, strideU, V, ldv, strideV, ifail, strideF, info, batch_count);
}
