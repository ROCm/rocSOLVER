...
*/
    ...
    if(blk == 0)
        blk = n;
    //    char* blkC = std::getenv("BLK_GETRI");
                                        ...
                                        bool optim_mem)
{
    ...
    //    if(blk < 0)
    //    {
    //        // if indicated block size is negative, use implementation with local BLAS operations
    ...
    //    else
    //    {
    // otherwise use implementation that calls rocBLAS
