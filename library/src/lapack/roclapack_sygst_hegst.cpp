                                          ...
                                          const rocblas_int ldb)
{
    ...
    void *scalars, *work_gur_x_temp, *workArr_temp_arr, *store_gcs_invA, *invA_arr;
    ...
    scalars = mem[0];
    work_gur_x_temp = mem[1];
    workArr_temp_arr = mem[2];
    store_gcs_invA = mem[3];
    invA_arr = mem[4];
    if(size_scalars > 0)
    ...
    return rocsolver_sygst_hegst_template<false, false, S, T>(
        ...
        (T*)scalars, work_gur_x_temp, workArr_temp_arr, store_gcs_invA, invA_arr, optim_mem);
}
