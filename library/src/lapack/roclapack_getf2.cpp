                                    ...
                                    rocblas_int* info)
{
    ...
    rocsolver_getf2_getMemorySize<false, PIVOT, T>(m, n, batch_count, &size_scalars, &size_pivotval,
                                                   &size_pivotidx);
    ...
    // execution
    return rocsolver_getf2_template<false, PIVOT, T>(handle, m, n, A, shiftA, lda, strideA, ipiv,
