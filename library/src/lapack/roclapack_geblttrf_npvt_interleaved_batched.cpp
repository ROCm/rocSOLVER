                                                                ...
                                                                const rocblas_int batch_count)
{
    ...
    // argument checking
    rocblas_status st = rocsolver_geblttrf_npvt_interleaved_argCheck(
        handle, nb, nblocks, lda, ldb, ldc, A, B, C, info, batch_count);
    ...
    rocsolver_geblttrf_npvt_interleaved_getMemorySize<T>(nb, nblocks, batch_count, &size_work);
    ...
    // Execution
    return rocsolver_geblttrf_npvt_interleaved_template<T>(handle, nb, nblocks, A, lda, B, ldb, C,
                                                           ldc, info, batch_count, work);
}
...
rocblas_status rocsolver_sgeblttrf_npvt_interleaved_batched(rocblas_handle handle,
                                                            ...
                                                            const rocblas_int batch_count)
{
    return rocsolver_geblttrf_npvt_interleaved_batched_impl<float>(handle, nb, nblocks, A, lda, B,
...
rocblas_status rocsolver_dgeblttrf_npvt_interleaved_batched(rocblas_handle handle,
                                                            ...
                                                            const rocblas_int batch_count)
{
    return rocsolver_geblttrf_npvt_interleaved_batched_impl<double>(handle, nb, nblocks, A, lda, B,
                                                                    ldb, C, ldc, info, batch_count);
}
