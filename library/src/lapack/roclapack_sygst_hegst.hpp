...
void rocsolver_sygst_hegst_getMemorySize(const rocblas_eform itype,
                                         ...
                                         size_t* size_scalars,
                                         size_t* size_work_gur_x_temp,
                                         size_t* size_workArr_temp_arr,
                                         size_t* size_store_gcs_invA,
                                         size_t* size_invA_arr)
{
    ...
    {
        *size_scalars = 0;
        *size_work_gur_x_temp = 0;
        *size_workArr_temp_arr = 0;
        *size_store_gcs_invA = 0;
        *size_invA_arr = 0;
        return;
    }
    ...
    if(n < xxGST_xxGS2_BLOCKSIZE)
    {
        ...
        rocsolver_sygs2_hegs2_getMemorySize<T, BATCHED>(itype, n, batch_count, size_scalars,
                                                        size_work_gur_x_temp, size_store_gcs_invA,
    ...
    else
    {
        ...
        *size_invA_arr = 0;
        ...
        if(itype == rocblas_eform_ax)
        {
            ...
            *size_work_gur_x_temp = max(*size_work_gur_x_temp, max(temp1, temp5));
            *size_workArr_temp_arr = max(*size_workArr_temp_arr, max(temp2, temp6));
            *size_store_gcs_invA = max(*size_store_gcs_invA, max(temp3, temp7));
                                              ...
                                              bool optim_mem)
{
    ...
    if(n <= nb)
        return rocsolver_sygs2_hegs2_template<BATCHED, T>(
            ...
            scalars, work_gur_x_temp, store_gcs_invA, (T**)workArr_temp_arr);
        ...
        if(uplo == rocblas_fill_upper)
        {
            ...
            for(rocblas_int k = 0; k < n; k += nb)
            {
                ...
                rocsolver_sygs2_hegs2_template<BATCHED, T>(
                    ...
                    shiftB + idx2D(k, k, ldb), ldb, strideB, batch_count, scalars, work_gur_x_temp,
                    store_gcs_invA, (T**)workArr_temp_arr);
                ...
                if(k + kb < n)
                {
                    rocblasCall_trsm<BATCHED, T>(
                        ...
                        lda, strideA, batch_count, optim_mem, work_gur_x_temp, workArr_temp_arr,
                        store_gcs_invA, invA_arr);
                    ...
                    rocblasCall_trsm<BATCHED, T>(
                        ...
                        work_gur_x_temp, workArr_temp_arr, store_gcs_invA, invA_arr);
                }
            }
        }
        else
