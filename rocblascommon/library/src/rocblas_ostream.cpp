...
// Predeclare rocsolver_abort_once() for friend declaration in rocsolver_ostream.hpp
...
std::shared_ptr<rocsolver_ostream::worker> rocsolver_ostream::get_worker(int fd)
{
...
// Construct rocsolver_ostream from a filename opened for writing with truncation
