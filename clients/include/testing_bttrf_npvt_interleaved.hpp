...
template <typename T>
void testing_bttrf_npvt_interleaved_bad_arg()
{
    // safe arguments
...
void bttrf_npvt_interleaved_initData(const rocblas_handle handle,
                                     const rocblas_int nb,
                                     const rocblas_int nblocks,
                                     Td& dA,
                                     const rocblas_int lda,
...
template <typename T>
void testing_bttrf_npvt_interleaved(Arguments& argus)
{
    // get arguments
    rocblas_local_handle handle;
...
#define EXTERN_TESTING_BTTRF_NPVT_INTERLEAVED(...) \
    extern template void testing_bttrf_npvt_interleaved<__VA_ARGS__>(Arguments&);

INSTANTIATE(EXTERN_TESTING_BTTRF_NPVT_INTERLEAVED, FOREACH_SCALAR_TYPE, APPLY_STAMP)
