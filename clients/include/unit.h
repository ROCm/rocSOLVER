...
template <typename T>
void unit_check_general(rocblas_int M, rocblas_int N, rocblas_int lda, T *hCPU,
                        T *hGPU);
...
template <typename T>
void potf2_err_res_check(T max_error, rocblas_int N, T forward_tolerance,
                         T eps);
...
template <typename T>
void getrs_err_res_check(T max_error, rocblas_int M, rocblas_int nhrs,
                         T forward_tolerance, T eps);
