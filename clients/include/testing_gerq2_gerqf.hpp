                          ...
                          double* max_err)
{
    ...
    for(rocblas_int b = 0; b < bc; ++b)
    {
        GERQF ? cblas_gerqf<T>(m, n, hA[b], lda, hIpiv[b], hW.data(), m)
              : cblas_gerq2<T>(m, n, hA[b], lda, hIpiv[b], hW.data());
    }
...
extern template void testing_gerq2_gerqf<false, false, 0, double>(Arguments& argus);
extern template void testing_gerq2_gerqf<false, false, 0, float>(Arguments& argus);
extern template void testing_gerq2_gerqf<true, true, 0, double>(Arguments& argus);
extern template void testing_gerq2_gerqf<true, true, 0, float>(Arguments& argus);
extern template void testing_gerq2_gerqf<false, true, 0, double>(Arguments& argus);
extern template void testing_gerq2_gerqf<false, true, 0, float>(Arguments& argus);
extern template void testing_gerq2_gerqf<false, false, 1, double>(Arguments& argus);
extern template void testing_gerq2_gerqf<false, false, 1, float>(Arguments& argus);
extern template void testing_gerq2_gerqf<true, true, 1, double>(Arguments& argus);
extern template void testing_gerq2_gerqf<true, true, 1, float>(Arguments& argus);
extern template void testing_gerq2_gerqf<false, true, 1, double>(Arguments& argus);
extern template void testing_gerq2_gerqf<false, true, 1, float>(Arguments& argus);
