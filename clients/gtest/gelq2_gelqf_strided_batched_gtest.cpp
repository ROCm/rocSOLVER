...
Arguments setup_arguments_sblq(lq_tuple tup) 
{
...
class LQfact_sb : public ::TestWithParam<lq_tuple> {
protected:
  LQfact_sb() {}
  virtual ~LQfact_sb() {}
  virtual void SetUp() {}
...
INSTANTIATE_TEST_CASE_P(daily_lapack, LQfact_sb,
                        Combine(ValuesIn(large_matrix_size_range),
                                ValuesIn(large_n_size_range)));

INSTANTIATE_TEST_CASE_P(checkin_lapack, LQfact_sb,
