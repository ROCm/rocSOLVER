...
// scal
/*template <>
void cpu_scal<float>(rocblas_int n, const float alpha, float *x,
                       rocblas_int incx) {
  cpu_sscal(n, alpha, x, incx);
}

template <>
void cpu_scal<double>(rocblas_int n, const double alpha, double *x,
                        rocblas_int incx) {
  cpu_dscal(n, alpha, x, incx);
}

template <>
void cpu_scal<rocblas_float_complex>(rocblas_int n,
                                       const rocblas_float_complex alpha,
                                       rocblas_float_complex *x,
                                       rocblas_int incx) {
  cpu_cscal(n, &alpha, x, incx);
}

template <>
void cpu_scal<rocblas_double_complex>(rocblas_int n,
                                        const rocblas_double_complex alpha,
                                        rocblas_double_complex *x,
                                        rocblas_int incx) {
  cpu_zscal(n, &alpha, x, incx);
}

// copy
template <>
void cpu_copy<float>(rocblas_int n, float *x, rocblas_int incx, float *y,
                       rocblas_int incy) {
  cpu_scopy(n, x, incx, y, incy);
}

template <>
void cpu_copy<double>(rocblas_int n, double *x, rocblas_int incx, double *y,
                        rocblas_int incy) {
  cpu_dcopy(n, x, incx, y, incy);
}

template <>
void cpu_copy<rocblas_float_complex>(rocblas_int n, rocblas_float_complex *x,
                                       rocblas_int incx,
                                       rocblas_float_complex *y,
                                       rocblas_int incy) {
  cpu_ccopy(n, x, incx, y, incy);
}

template <>
void cpu_copy<rocblas_double_complex>(rocblas_int n,
                                        rocblas_double_complex *x,
                                        rocblas_int incx,
                                        rocblas_double_complex *y,
                                        rocblas_int incy) {
  cpu_zcopy(n, x, incx, y, incy);
}

// axpy
template <>
void cpu_axpy<float>(rocblas_int n, float alpha, float *x, rocblas_int incx,
                       float *y, rocblas_int incy) {
  cpu_saxpy(n, alpha, x, incx, y, incy);
}

template <>
void cpu_axpy<double>(rocblas_int n, double alpha, double *x,
                        rocblas_int incx, double *y, rocblas_int incy) {
  cpu_daxpy(n, alpha, x, incx, y, incy);
}

template <>
void cpu_axpy<rocblas_float_complex>(
  ...
  cpu_caxpy(n, &alpha, x, incx, y, incy);
}

template <>
void cpu_axpy<rocblas_double_complex>(
  ...
  cpu_zaxpy(n, &alpha, x, incx, y, incy);
}

// swap
template <>
void cpu_swap<float>(rocblas_int n, float *x, rocblas_int incx, float *y,
                       rocblas_int incy) {
  cpu_sswap(n, x, incx, y, incy);
}

template <>
void cpu_swap<double>(rocblas_int n, double *x, rocblas_int incx, double *y,
                        rocblas_int incy) {
  cpu_dswap(n, x, incx, y, incy);
}

template <>
void cpu_swap<rocblas_float_complex>(rocblas_int n, rocblas_float_complex *x,
                                       rocblas_int incx,
                                       rocblas_float_complex *y,
                                       rocblas_int incy) {
  cpu_cswap(n, x, incx, y, incy);
}

template <>
void cpu_swap<rocblas_double_complex>(rocblas_int n,
                                        rocblas_double_complex *x,
                                        rocblas_int incx,
                                        rocblas_double_complex *y,
                                        rocblas_int incy) {
  cpu_zswap(n, x, incx, y, incy);
}

// dot
template <>
void cpu_dot<float>(rocblas_int n, const float *x, rocblas_int incx,
                      const float *y, rocblas_int incy, float *result) {
  *result = cpu_sdot(n, x, incx, y, incy);
}

template <>
void cpu_dot<double>(rocblas_int n, const double *x, rocblas_int incx,
                       const double *y, rocblas_int incy, double *result) {
  *result = cpu_ddot(n, x, incx, y, incy);
}

template <>
void cpu_dot<rocblas_float_complex>(rocblas_int n,
                                      const rocblas_float_complex *x,
                                      rocblas_int incx,
                                      const rocblas_float_complex *y,
                                      rocblas_int incy,
                                      rocblas_float_complex *result) {
  cpu_cdotu_sub(n, x, incx, y, incy, result);
}

template <>
void cpu_dot<rocblas_double_complex>(rocblas_int n,
                                       const rocblas_double_complex *x,
                                       rocblas_int incx,
                                       const rocblas_double_complex *y,
                                       rocblas_int incy,
                                       rocblas_double_complex *result) {
  cpu_zdotu_sub(n, x, incx, y, incy, result);
}

// nrm2
template <>
void cpu_nrm2<float, float>(rocblas_int n, const float *x, rocblas_int incx,
                              float *result) {
  *result = cpu_snrm2(n, x, incx);
}

template <>
void cpu_nrm2<double, double>(rocblas_int n, const double *x,
                                rocblas_int incx, double *result) {
  *result = cpu_dnrm2(n, x, incx);
}

template <>
void cpu_nrm2<rocblas_float_complex, float>(rocblas_int n,
                                              const rocblas_float_complex *x,
                                              rocblas_int incx, float *result) {
  *result = cpu_scnrm2(n, x, incx);
}

template <>
void cpu_nrm2<rocblas_double_complex, double>(rocblas_int n,
                                                const rocblas_double_complex *x,
                                                rocblas_int incx,
                                                double *result) {
  *result = cpu_dznrm2(n, x, incx);
}

// asum
template <>
void cpu_asum<float, float>(rocblas_int n, const float *x, rocblas_int incx,
                              float *result) {
  *result = cpu_sasum(n, x, incx);
}

template <>
void cpu_asum<double, double>(rocblas_int n, const double *x,
                                rocblas_int incx, double *result) {
  *result = cpu_dasum(n, x, incx);
}

template <>
void cpu_asum<rocblas_float_complex, float>(rocblas_int n,
                                              const rocblas_float_complex *x,
                                              rocblas_int incx, float *result) {
  *result = cpu_scasum(n, x, incx);
}

template <>
void cpu_asum<rocblas_double_complex, double>(rocblas_int n,
                                                const rocblas_double_complex *x,
                                                rocblas_int incx,
                                                double *result) {
  *result = cpu_dzasum(n, x, incx);
}

// amax
template <>
void cpu_iamax<float>(rocblas_int n, const float *x, rocblas_int incx,
                        rocblas_int *result) {
  *result = (rocblas_int)cpu_isamax(n, x, incx);
}

template <>
void cpu_iamax<double>(rocblas_int n, const double *x, rocblas_int incx,
                         rocblas_int *result) {
  *result = (rocblas_int)cpu_idamax(n, x, incx);
}

template <>
void cpu_iamax<rocblas_float_complex>(rocblas_int n,
                                        const rocblas_float_complex *x,
                                        rocblas_int incx, rocblas_int *result) {
  *result = (rocblas_int)cpu_icamax(n, x, incx);
}

template <>
void cpu_iamax<rocblas_double_complex>(rocblas_int n,
                                         const rocblas_double_complex *x,
                                         rocblas_int incx,
                                         rocblas_int *result) {
  *result = (rocblas_int)cpu_izamax(n, x, incx);
}
*/
// gemv
template <>
...
/*
template <>
void cpu_ger<float>(rocblas_int m, rocblas_int n, float alpha, float *x,
                      rocblas_int incx, float *y, rocblas_int incy, float *A,
                      rocblas_int lda) {
  cpu_sger(CblasColMajor, m, n, alpha, x, incx, y, incy, A, lda);
}

template <>
void cpu_ger<double>(rocblas_int m, rocblas_int n, double alpha, double *x,
                       rocblas_int incx, double *y, rocblas_int incy, double *A,
                       rocblas_int lda) {
  cpu_dger(CblasColMajor, m, n, alpha, x, incx, y, incy, A, lda);
}

template <>
void cpu_syr<float>(rocblas_fill uplo, rocblas_int n, float alpha, float *x,
                      rocblas_int incx, float *A, rocblas_int lda) {
  cpu_ssyr(CblasColMajor, (CBLAS_UPLO)uplo, n, alpha, x, incx, A, lda);
}

template <>
void cpu_syr<double>(rocblas_fill uplo, rocblas_int n, double alpha,
                       double *x, rocblas_int incx, double *A,
                       rocblas_int lda) {
  cpu_dsyr(CblasColMajor, (CBLAS_UPLO)uplo, n, alpha, x, incx, A, lda);
}
*/
